...
const UpdatePayroll = ({ openDialog, handleCloseDialog, selectedRow, setSelectedRow, page, limit }) => {
                        ...
                        <>
                            ...
                            <DialogContent>
                                <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                                    <Grid item xs={12}>
                                        <FormControl fullWidth required InputLabelProps={{ shrink: true }} label="Payroll Status">
