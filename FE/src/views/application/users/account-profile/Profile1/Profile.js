...
const Profile = () => {
    ...
    const rows = [
        createData('Full Name', ':', user?.name.concat(' ', user?.lastname) || '-'),
        createData(),
        createData('Fathers Name', ':', user?.fathers_name || '-'),
        createData('Address', ':', user?.address || '-'),
        createData('Zip Code', ':', user?.zip_code || '-'),
        createData('Phone', ':', user?.phone_number || '-'),
        createData('Email', ':', user?.user_email || '-'),
        createData('Website', ':', user?.website || '-')
    ];
